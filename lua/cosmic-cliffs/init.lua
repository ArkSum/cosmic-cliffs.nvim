...
function M.setup()
	...
	set(0, "LineNrAbove", { fg = colors.light_black, bg = colors.white }) -- Doesn't seem to work
	set(0, "LineNr", { fg = colors.purple, bg = colors.white }) -- Doesn't seem to work
	set(0, "LineNrBelow", { fg = colors.light_black, bg = colors.white }) -- Doesn't seem to work

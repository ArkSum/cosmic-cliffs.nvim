...
function M.setup()
	...
	set(0, "Folded", { bg = colors.gray_6, fg = colors.black })
	...
	set(0, "PmenuSel", { bg = colors.gray_4, fg = colors.light_white })
	set(0, "ColorColumn", { bg = colors.light_magenta, fg = colors.black })

...
function M.setup()
	...
	set(0, "DiagnosticUnderlineHint", { fg = colors.icy_blue })
	set(0, "DiagnosticUnderlineOk", { fg = colors.light_white })
	set(0, "DiagnosticUnderlineWarn", { fg = colors.light_orange })
	set(0, "DiagnosticUnderlineError", { fg = colors.light_red })

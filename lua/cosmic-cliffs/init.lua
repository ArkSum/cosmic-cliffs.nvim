...
function M.setup()
	...
	set(0, "Directory", { fg = colors.gray_3 })
	...
	set(0, "Visual", { bg = colors.gray_3 })
	set(0, "CurSearch", { fg = colors.black, bg = colors.light_yellow })
	set(0, "Search", { fg = colors.black, bg = colors.light_yellow })
	set(0, "CursorLine", { bg = colors.gray_3 })
	set(0, "Conceal", { fg = colors.gray_2 })
	set(0, "NonText", { fg = colors.gray_2 })
